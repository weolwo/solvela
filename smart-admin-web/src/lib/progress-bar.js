 ...
 *   :root { --smart-progress-color: #1677ff; }
 *
 * @Author:    alaric
 * @Date:      2026-08-01
 */
...
function ensureBar() {
  ...
  bar.className = 'smart-progress-bar';
  ...
  Object.assign(bar.style, {
    ...
    zIndex: '2000',
    background: 'var(--smart-progress-color, #1677ff)',
    boxShadow: '0 0 8px var(--smart-progress-color, #1677ff)',
    opacity: '0',
    // 进度条不该拦住任何点击
    pointerEvents: 'none',
