...
<template>
  ...
  <a-form class="smart-query-form">
    <a-row class="smart-query-form-row">
      ...
      <a-form-item label="开关" class="smart-query-form-item">
        <a-select style="width: 130px" v-model:value="queryForm.status" :options="POOL_STATUS_OPTIONS" placeholder="全部" allowClear @change="onSearch" />
      </a-form-item>
