 ...
 * @Date 2026-08-08
 */
public class SmartServletUtilTest {
    ...
    public void 多个头同时存在时按候选顺序取优先级最高的() {
        ...
        assertEquals("1.1.1.1", SmartServletUtil.getClientIP(request));
    }
    ...
    public void 优先级更高的头是unknown时顺延到下一个() {
        ...
        request.addHeader("X-Real-IP", "2.2.2.2");
        assertEquals("2.2.2.2", SmartServletUtil.getClientIP(request));
    }
    ...
    private String getClientIp(String headerName, String headerValue) {
        ...
        return SmartServletUtil.getClientIP(request);
    }
}
