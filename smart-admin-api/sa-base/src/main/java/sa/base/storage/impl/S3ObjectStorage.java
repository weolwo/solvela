package sa.base.storage.impl;

import sa.base.storage.ByteRange;
import sa.base.storage.ObjectMeta;
import sa.base.storage.ObjectStorage;
import sa.base.storage.PresignCapable;
import sa.base.storage.StorageException;
 ...
 *
 * <p>⚠️ <b>本类会引用 AWS SDK 类型，而该依赖在 sa-base 里是 {@code optional} 的</b>
