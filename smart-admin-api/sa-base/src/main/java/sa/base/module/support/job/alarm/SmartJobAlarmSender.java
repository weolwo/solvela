package sa.base.module.support.job.alarm;
 ...
 * 把通道抽出来，换落点时不用碰调度内核。
 *
 * <p>默认实现 {@link SmartJobLogAlarmSender} 只落 ERROR 日志 ——
 * 已经比「完全不知道」好，但仍需要有人去看日志，所以生产环境应当再挂一个真实通道。
 *
 * @author alaric
 * @date 2026-08-11
 */
public interface SmartJobAlarmSender {
     ...
     * @param title    一句话标题
     * @param content  明细
     * @param receiver 接收人（来自 {@code t_smart_job.alarm_receiver}，可能为空）
     */
