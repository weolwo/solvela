...
import sa.base.module.support.job.api.domain.SmartJobQueryForm;
import sa.base.module.support.job.api.domain.SmartJobVO;
...
public interface SmartJobDao extends BaseMapper<SmartJobEntity> {
     ...
     */
    List<SmartJobEntity> selectByHandlerName(@Param("handlerName") String handlerName);
     ...
     */
    List<SmartJobEntity> selectDueJobList(@Param("appEnv") String appEnv,
     ...
     */
    List<SmartJobEntity> selectOverdueJobList(@Param("appEnv") String appEnv,
