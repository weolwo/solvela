...
@Getter
@AllArgsConstructor
public enum SmartJobMisfireStrategyEnum implements BaseEnum {
    ...
    public static SmartJobMisfireStrategyEnum resolve(String value) {
        for (SmartJobMisfireStrategyEnum e : values()) {
