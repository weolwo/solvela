package sa.base.module.support.operatelog.core;
...
import sa.base.module.support.operatelog.OperateLogDao;
import sa.base.module.support.operatelog.annotation.OperateLog;
import sa.base.module.support.operatelog.domain.OperateLogEntity;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(sa.base.module.support.operatelog.annotation.OperateLog) || @annotation(sa.base.module.support.operatelog.annotation.OperateLog)";
