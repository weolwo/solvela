package sa.admin.module.member.verify.controller;
...
import sa.member.verify.domain.form.MemberVerifyRejectForm;
import sa.member.verify.domain.vo.MemberVerifyDetailVO;
...
public class MemberVerifyController {
    ...
    public ResponseDTO<String> approve(@PathVariable Long id) {
        return memberVerifyService.approve(id, SmartRequestUtil.getRequestUser());
    }
