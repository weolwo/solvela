package sa.admin.module.risk.promotionconfig.controller;

import sa.base.common.domain.ValidateList;
import sa.risk.promotionconfig.domain.entity.PromotionConfig;
import sa.risk.promotionconfig.domain.form.PromotionConfigAddForm;
import sa.risk.promotionconfig.domain.form.PromotionConfigQueryForm;
import sa.risk.promotionconfig.domain.form.PromotionConfigUpdateForm;
import sa.risk.promotionconfig.domain.vo.PromotionConfigOptionVO;
import sa.risk.promotionconfig.domain.vo.PromotionConfigVO;
import sa.risk.promotionconfig.service.PromotionConfigService;
