...
import sa.base.module.support.file.domain.vo.FileCategoryVO;
import sa.base.module.support.file.service.FileCategoryService;
...
public class FileCategoryController extends SupportBaseController {
    ...
    public ResponseDTO<FileCategoryEntity> add(@RequestBody @Valid FileCategoryEntity form) {
        return ResponseDTO.ok(fileCategoryService.add(form, SmartRequestUtil.getRequestUser()));
    }
    ...
    public ResponseDTO<String> update(@RequestBody @Valid FileCategoryEntity form) {
        fileCategoryService.update(form, SmartRequestUtil.getRequestUser());
    ...
    public ResponseDTO<String> reorder(@RequestBody List<Long> orderedIds) {
        fileCategoryService.reorder(orderedIds, SmartRequestUtil.getRequestUser());
        return ResponseDTO.ok();
    }
}
