package sa.task.taskevent.service;
...
import sa.task.taskevent.dao.TaskEventDao;
import sa.task.taskevent.domain.entity.TaskEvent;
import sa.task.taskevent.domain.form.TaskEventAddForm;
import sa.task.taskevent.domain.form.TaskEventQueryForm;
import sa.task.taskevent.domain.form.TaskEventUpdateForm;
import sa.task.taskevent.domain.vo.TaskEventOptionVO;
import sa.task.taskevent.domain.vo.TaskEventVO;
...
public class TaskEventDefService {
    ...
    public ResponseDTO<String> update(TaskEventUpdateForm updateForm) {
        ...
        TaskEvent entity = SmartBeanUtil.copy(updateForm, TaskEvent.class);
