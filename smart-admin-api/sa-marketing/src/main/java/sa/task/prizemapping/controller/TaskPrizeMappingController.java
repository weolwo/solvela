package sa.task.prizemapping.controller;

import sa.task.prizemapping.domain.form.TaskPrizeMappingQueryForm;
import sa.task.prizemapping.domain.vo.TaskPrizeMappingVO;
import sa.task.prizemapping.service.TaskPrizeMappingService;
 ...
 *
 * <p>删除同理不给：它确实能让 {@link sa.task.runtime.TaskPrizeDispatcher} 发不出奖，
