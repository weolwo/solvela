package sa.lottery.config.controller;
...
import sa.lottery.config.domain.vo.LotteryConfigBoardResultVO;
import sa.lottery.config.service.LotteryConfigBoardService;
