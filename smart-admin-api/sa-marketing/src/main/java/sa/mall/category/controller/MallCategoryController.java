...
import sa.mall.category.domain.form.MallCategoryBatchSaveForm;
import sa.mall.category.domain.form.MallCategoryQueryForm;
import sa.mall.category.domain.form.MallCategorySaveForm;
...
public class MallCategoryController {
    ...
    public ResponseDTO<Long> save(@RequestBody @Valid MallCategorySaveForm saveForm) {
        return mallCategoryService.save(saveForm, SmartRequestUtil.getRequestUser());
    }
    ...
    public ResponseDTO<Integer> batchSave(@RequestBody @Valid MallCategoryBatchSaveForm batchSaveForm) {
        return mallCategoryService.batchSave(batchSaveForm, SmartRequestUtil.getRequestUser());
    }
    ...
    public ResponseDTO<String> updateStatus(@PathVariable Long id, @PathVariable Integer status) {
        return mallCategoryService.updateStatus(id, status, SmartRequestUtil.getRequestUser());
    }
