...
import sa.stat.dao.MarketingStatDao;
import sa.stat.domain.vo.EventHealthVO;
import sa.stat.domain.vo.GameplayVO;
import sa.stat.domain.vo.OverviewVO;
import sa.stat.domain.vo.ParticipationByTypeVO;
import sa.stat.domain.vo.ParticipationTrendVO;
...
public class MarketingStatService {
    ...
    /**
     * 各玩法的引用查询实现，由 sa-marketing 注册（依赖倒置，见 ActivityRefProvider 类注释）。
