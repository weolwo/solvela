package solarx.app.module.login.controller;
...
import solarx.app.module.login.service.MemberLoginService;
...
public class MemberLoginController {
    ...
    public ResponseDTO<MemberLoginResultVO> getLoginInfo() {
        RequestMember requestMember = (RequestMember) SmartRequestUtil.getRequestUser();
    ...
    public ResponseDTO<String> logout() {
        return memberLoginService.logout((RequestMember) SmartRequestUtil.getRequestUser());
    }
}
