...
import sa.scriptengine.domain.ScriptParam;
...
public enum ScriptScene {
     ...
     * 变量取自 {@code sa.task.runtime.domain.TaskEventContext} + 当前 {@code TaskRecord}。
     */
     ...
     * 变量取自 {@code sa.draw.runtime.domain.DrawExecuteForm}。
     */
