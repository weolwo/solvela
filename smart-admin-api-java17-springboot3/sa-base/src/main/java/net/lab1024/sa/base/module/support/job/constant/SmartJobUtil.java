...
public class SmartJobUtil {
    ...
    public static List<LocalDateTime> queryNextTimeList(String triggerType, String triggerValue,
        ...
        if (null == baseTime || SmartJobTriggerTypeEnum.ONE_TIME.equalsValue(triggerType)) {
