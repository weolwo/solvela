 ...
 * @date 2026-08-11
 */
public record SmartJobContext(String jobCode,
                              String jobName,
                              String handlerName,
                              String param,
                              LocalDate bizDate,
    ...
    private java.util.Map<String, Object> paramMap() {
        ...
        try {
            java.util.Map<String, Object> map = net.lab1024.sa.base.common.util.JsonUtils
    ...
    public void checkCancelled() {
        if (this.isCancelled()) {
            throw new SmartJobCancelledException("任务被中断（超时或节点停机）");
        }
    }
}
