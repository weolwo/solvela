 ...
 * 任务被中断（超时或节点停机）。
 *
 * <p>由 {@link SmartJobContext#checkCancelled()} 抛出。框架据此把执行记录落成
 ...
 * @date 2026-08-11
 */
public class SmartJobCancelledException extends RuntimeException {

    public SmartJobCancelledException(String message) {
