package net.lab1024.sa.activity.spi;
 ...
 *
 * <h3>为什么要有这个接口</h3>
 * 三个玩法表（t_prize_pool_config / t_task_config / t_lottery_config）的 Dao 都在 sa-marketing，
 * 而本类所在的 common-api 是 sa-marketing 的<b>上游</b> —— common-api 直接引用它们会造成循环依赖。
 * 故用依赖倒置：<b>common-api 定契约，sa-marketing 实现并注册为 Bean</b>。
