...
/**
 * 彩票工作台聚合回显VO：与聚合保存 LotteryWorkbenchSaveForm 同构，前端拿到即可直接填回表单。
 *
 ...
 * @Date 2026-07-27
 */
public record LotteryWorkbenchVO(String activityCode,
                                 String activityName,
                                 String lotteryCode,
                                 String lotteryName,
                                 ...
                                 long issueCount,
                                 long soldTotal,
                                 List<LotteryWorkbenchRuleVO> prizeRuleList) {
}
