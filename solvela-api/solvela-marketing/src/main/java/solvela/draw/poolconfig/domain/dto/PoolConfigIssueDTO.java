...
public class PoolConfigIssueDTO {
    ...
    public static PoolConfigIssueDTO danger(String code, String message) {
        return new PoolConfigIssueDTO(code, "DANGER", message);
    }

    public static PoolConfigIssueDTO warn(String code, String message) {
        return new PoolConfigIssueDTO(code, "WARN", message);
    }
}
