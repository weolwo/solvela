...
public class PrizeRuleIssueDTO {
    ...
    public static PrizeRuleIssueDTO danger(String code, String message) {
        return new PrizeRuleIssueDTO(code, "DANGER", message);
    }

    public static PrizeRuleIssueDTO warn(String code, String message) {
        return new PrizeRuleIssueDTO(code, "WARN", message);
    }
}
