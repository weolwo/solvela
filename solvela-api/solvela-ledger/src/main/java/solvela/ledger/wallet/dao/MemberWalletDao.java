package solvela.ledger.wallet.dao;
...
public interface MemberWalletDao extends BaseMapper<MemberWallet> {
     ...
     * @return 列表数据
     */
    List<MemberWalletDTO> queryPage(Page<?> page, @Param("queryForm") MemberWalletQuery queryForm);
     ...
     * @return 列表数据
     */
    List<MemberWalletDTO> queryList(@Param("queryForm") MemberWalletQuery queryForm);
