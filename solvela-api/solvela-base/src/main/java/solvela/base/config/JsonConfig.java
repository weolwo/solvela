...
import solvela.base.common.json.serializer.LongJsonSerializer;
...
public class JsonConfig {
    ...
    public JsonMapperBuilderCustomizer customizer() {
        return builder -> {
            ...
            module.addDeserializer(LocalDate.class, new LocalDateDeserializer(SolvelaDateFormatterEnum.YMD.getFormatter()));
            module.addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(SolvelaDateFormatterEnum.YMD_HMS.getFormatter()));
            module.addSerializer(LocalDate.class, new LocalDateSerializer(SolvelaDateFormatterEnum.YMD.getFormatter()));
            module.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(SolvelaDateFormatterEnum.YMD_HMS.getFormatter()));
    ...
    public static class StringToLocalDateTime implements Converter<String, LocalDateTime> {
        ...
        public LocalDateTime convert(String str) {
            ...
            try {
                localDateTime = SolvelaLocalDateUtil.parse(str, SolvelaDateFormatterEnum.YMD_HMS);
    ...
    public static class StringToLocalDate implements Converter<String, LocalDate> {
        ...
        public LocalDate convert(String str) {
            ...
            LocalDate localDate;
            try {
                localDate = SolvelaLocalDateUtil.parseDate(str, SolvelaDateFormatterEnum.YMD);
            } catch (DateTimeParseException e) {
