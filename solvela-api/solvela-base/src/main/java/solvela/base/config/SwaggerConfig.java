...
import solvela.base.common.swagger.SolvelaOperationCustomizer;
...
public class SwaggerConfig {
    ...
    /**
     * @deprecated 已移到 {@link solvela.base.constant.SwaggerWhitelistConst#SWAGGER_WHITELIST}。
     * 拦截器等非文档代码请直接引那边，别引这里 —— 引用本类会连带加载 springdoc 类型，
     * 而生产包里没有它们。保留这个别名只为兼容外部引用。
     */
    @Deprecated
    public static final String[] SWAGGER_WHITELIST = solvela.base.constant.SwaggerWhitelistConst.SWAGGER_WHITELIST;
    ...
    public GroupedOpenApi businessApi() {
        return GroupedOpenApi.builder()
                ...
                .addOperationCustomizer(new SolvelaOperationCustomizer())
                .build();
