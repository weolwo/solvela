...
@Getter
@AllArgsConstructor
public enum SolvelaJobBlockStrategyEnum implements BaseEnum {
     ...
     * 中断上一次，跑本次。
     *
     * <p>⚠️ 中断能不能生效取决于执行器有没有响应中断（见 {@code SolvelaJob} 的 javadoc）。
    ...
    public static SolvelaJobBlockStrategyEnum resolve(String value) {
        for (SolvelaJobBlockStrategyEnum e : values()) {
