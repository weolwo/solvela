 ...
 */
@Data
@TableName("t_solvela_job")
public class SolvelaJobEntity {
    ...
    /**
     * 执行器名称，对应 {@code @SolvelaJobHandler#name()}。
     *
     ...
     * 理由见 {@code SolvelaJobPresetEnum.NORMAL} 的注释（与背压跳过直接冲突）
     */
