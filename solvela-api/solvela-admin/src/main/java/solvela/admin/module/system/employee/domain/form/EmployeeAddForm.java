package solvela.admin.module.system.employee.domain.form;
...
public class EmployeeAddForm {
    ...
    @Pattern(regexp = SolvelaVerificationUtil.PHONE_REGEXP, message = "手机号格式不正确")
    private String phone;

    @Schema(description = "邮箱账号")
    @NotNull(message = "邮箱账号不能为空")
    @Pattern(regexp = SolvelaVerificationUtil.EMAIL, message = "邮箱账号格式不正确")
