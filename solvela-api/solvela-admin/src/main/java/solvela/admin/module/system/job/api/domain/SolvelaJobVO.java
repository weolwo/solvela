...
public class SolvelaJobVO {
    ...
    @Schema(description = "执行器中文标题，来自 @SolvelaJobHandler#title，代码里查不到时为空")
    ...
    @EnumSerialize(SolvelaJobTriggerTypeEnum.class)
    ...
    private SolvelaJobLogVO lastJobLog;
