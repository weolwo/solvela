...
import solvela.base.common.util.SolvelaContentDispositionUtil;
...
import solvela.base.module.support.file.domain.vo.FileUploadVO;
    ...
    private void writeFile(FileEntity file, boolean inline,
        ...
        try (StoredObject object = fileAssetService.open(file, resolved.range())) {
            ...
            response.setHeader(HttpHeaders.CONTENT_DISPOSITION, inline
                    ? SolvelaContentDispositionUtil.inline(fileName)
                    : SolvelaContentDispositionUtil.attachment(fileName));
