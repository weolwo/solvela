...
public class LotterySettleController {
    ...
    public String randomNumber(@RequestParam Long issueId) {
    ...
    public SettleResultDTO settle(@RequestParam Long issueId,
    ...
    @RequiresPermission("lotteryIssue:query")
    public Map<String, Object> settleSummary(@RequestParam Long issueId) {
    ...
    @RequiresPermission("lotteryIssue:update")
    public Integer dispatch(@RequestParam Long issueId) {
