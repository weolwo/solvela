 ...
 *  水印DOM id
 */
const WATER_MARK_DOM_ID = 'solvela_water_mark';
let solvelaAdminWaterMarkIntervalId = null;
...
const watermark = {
    ...
    set: function (id, str) {
      ...
      //每隔1分钟检查一次水印
      solvelaAdminWaterMarkIntervalId = setInterval(() => {
        setWatermark(id, str);
      }, 60000);
    ...
    clear: function () {
        ...
        if (solvelaAdminWaterMarkIntervalId) {
          clearInterval(solvelaAdminWaterMarkIntervalId);
          solvelaAdminWaterMarkIntervalId = null;
        }
    },
};
