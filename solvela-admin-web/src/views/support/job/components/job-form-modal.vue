...
<script setup>
  ...
  async function doPreview() {
    const value = updateForm.triggerType === TRIGGER_TYPE_ENUM.CRON.value ? updateForm.cron : updateForm.oneTime;
    if (!value) {
      preview.value = null;
      return;
    }
  ...
  watch(() => [updateForm.triggerType, updateForm.cron, updateForm.oneTime, updateForm.presetCode], schedulePreview);
  const updateRules = {
