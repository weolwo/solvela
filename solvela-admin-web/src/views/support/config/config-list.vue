  ...
  <div>
    <a-form class="solvela-query-form">
      <a-row class="solvela-query-form-row">
        <a-form-item label="参数Key" class="solvela-query-form-item">
        ...
        <a-form-item class="solvela-query-form-item solvela-margin-left10">
          ...
          <a-button @click="toEditOrAdd()" v-privilege="'support:config:add'" type="primary" class="solvela-margin-left20">
            <template #icon>
              <PlusOutlined />
            </template>
            新建
