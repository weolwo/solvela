...
- 后端请看：@ApiEncrypt 和 @ApiDecrypt 注解，具体请看 sa-common项目中的 sa.common.module.support.apiencrypt 包
- demo请看：前端：/views/support/api-encrypt 目录，后端 请看：sa-admin项目的：sa.admin.module.system.support.AdminApiEncryptController
</pre>
    </template>
  </a-alert>
  <br />
  ...
  <a-card title="一、请求加密 Demo">
    <a-form class="solvela-query-form">
      <a-row class="solvela-query-form-row">
        <a-form-item label="姓名" class="solvela-query-form-item">
          <a-input v-model:value="requestEncryptForm.name" placeholder="姓名" />
        </a-form-item>
        <a-form-item label="年龄" class="solvela-query-form-item">
