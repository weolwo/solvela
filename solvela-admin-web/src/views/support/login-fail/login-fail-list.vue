...
<template>
  ...
  <a-form class="solvela-query-form">
    <a-row class="solvela-query-form-row">
      <a-form-item label="登录名" class="solvela-query-form-item">
        <a-input style="width: 300px" v-model:value="queryForm.loginName" placeholder="登录名" />
      </a-form-item>
      <a-form-item label="快速筛选" class="solvela-query-form-item">
      ...
      <a-form-item label="锁定时间" class="solvela-query-form-item">
        <a-range-picker
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    ...
    <a-row class="solvela-table-btn-block">
      ...
      <div class="solvela-table-setting-block">
        <TableOperator v-model="columns" :tableId="TABLE_ID_CONST.SUPPORT.LOGIN_FAIL" :refresh="queryData" />
      </div>
    </a-row>
    <!---------- 表格操作行 end ----------->
