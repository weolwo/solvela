...
-->
<template>
  <a-row class="solvela-margin-top10">
    <a-col flex="350px">
    ...
    <a-col flex="auto" style="height: auto; width: 500px" v-if="formData.isSupportInsertAndUpdate">
      <div class="form-preview">
        ...
        <a-row :gutter="20" class="solvela-margin-top10" justify="space-around">
          <a-col class="form-item" :span="spanPerLine" v-for="i of formData.countPerLine" :key="i">
            <div class="gutter-box">字段</div>
          </a-col>
        </a-row>
  ...
  >
    <template #bodyCell="{ text, record, index, column }">
      ...
      <template v-if="column.dataIndex === 'frontComponent'">
        <SolvelaEnumSelect width="100%" enum-name="CODE_FRONT_COMPONENT_ENUM" v-model:value="record.frontComponent" />
      </template>
    </template>
  </a-table>
</template>
