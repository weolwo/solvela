<template>
  <a-form class="solvela-query-form">
    <a-row class="solvela-query-form-row">
      <a-form-item label="部门名称" class="solvela-query-form-item">
      ...
      <a-form-item class="solvela-query-form-item solvela-margin-left10">
        ...
        <a-button v-privilege="'system:department:add'" type="primary" @click="addDepartment" class="solvela-margin-left20">
          <template #icon>
            <PlusOutlined />
          </template>
          新建
