...
<template>
  ...
  <a-form class="solvela-query-form">
    <a-row class="solvela-query-form-row">
      ...
      <a-form-item label="昵称" class="solvela-query-form-item">
      ...
      <a-form-item label="性别" class="solvela-query-form-item">
      ...
      <a-form-item label="来源渠道" class="solvela-query-form-item">
      ...
      <a-form-item label="注册时间" class="solvela-query-form-item">
