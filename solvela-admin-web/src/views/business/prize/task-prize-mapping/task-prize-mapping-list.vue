...
<template>
  ...
  <a-form class="solvela-query-form">
    <a-row class="solvela-query-form-row">
      ...
      <a-form-item label="归属活动" class="solvela-query-form-item">
        <a-select
          style="width: 260px"
      ...
      <a-form-item label="奖励编码" class="solvela-query-form-item">
...
<script setup>
  ...
  function rowClassName(record) {
    return record.issueList && record.issueList.length > 0 ? 'solvela-table-row-warning' : '';
  }
...
<style scoped lang="less">
  ...
  :deep(.solvela-table-row-warning) > td {
