...
<template>
  ...
  <a-form class="solvela-query-form">
    <a-row class="solvela-query-form-row">
      ...
      <a-form-item label="奖品级别" class="solvela-query-form-item">
        <a-input style="width: 200px" v-model:value="queryForm.prizeLevel" placeholder="奖品级别" />
      </a-form-item>
      <a-form-item label="奖品名称" class="solvela-query-form-item">
        <a-input style="width: 200px" v-model:value="queryForm.prizeName" placeholder="奖品名称" />
      </a-form-item>
      <a-form-item label="审批模式" class="solvela-query-form-item">
