...
<template>
  ...
  <a-card size="small" :bordered="false" :hoverable="true">
    <a-alert type="info" show-icon class="mb-3">
      <template #message>
        事件是任务的<b>输入</b>：上游埋点调 <code>POST /taskEvent/report</code> 上报，任务引擎据此推进进度。 新增一个事件只需在这里加一行 +
        上游埋点，<b>前端与后端都不用改代码</b>。
      </template>
    </a-alert>
