    ...
    <a-card :bordered="false" class="mb-4 shadow-sm" :body-style="{ padding: '16px 24px' }">
      <div class="flex flex-wrap items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-4">
          ...
          <a-popconfirm title="确认保存本玩法的配置？" ok-text="保存" cancel-text="再想想" :disabled="!currentActivity" @confirm="save">
      ...
      <a-spin v-else :spinning="detailLoading">
        <a-tabs v-model:activeKey="activeTab">
          ...
          <a-tab-pane key="issue" force-render>
            ...
            <IssueConsole ref="issueRef" :lottery-code="loadedLottery" :number-length="loadedNumberLength" :total-count="loadedTotalCount" />
          </a-tab-pane>
        </a-tabs>
      </a-spin>
    </a-card>
