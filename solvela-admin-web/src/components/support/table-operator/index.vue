...
<template>
  <span>
    ...
    <SolvelaTableColumnModal ref="solvelaTableColumnModal" @change="updateColumn" />
  </span>
</template>
...
<script setup>
  ...
  import SolvelaTableColumnModal from './solvela-table-column-modal.vue';
  ...
  function handleExitFullScreen() {
    document.querySelector('#solvelaAdminHeader').style.display = 'block';
  ...
  function launchElementFullScreen(element) {
    document.querySelector('#solvelaAdminHeader').style.display = 'none';
  ...
  const solvelaTableColumnModal = ref();

  function showModal() {
    solvelaTableColumnModal.value.show(newColumn, props.tableId);
  }
