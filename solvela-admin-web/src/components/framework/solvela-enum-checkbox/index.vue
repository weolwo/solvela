...
<script setup>
  ...
  onMounted(() => {
    ...
    const solvelaEnumPlugin = internalInstance.appContext.config.globalProperties.$solvelaEnumPlugin;
    valueDescList.value = solvelaEnumPlugin.getValueDescList(props.enumName).filter((item) => !props.hiddenOption.includes(item.value));
  });
