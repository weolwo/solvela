    ...
    <div v-if="showDiffModal" class="ios-modal-overlay">
      <div class="ios-modal-content">
        ...
        <div class="diff-editor-wrapper">
          <SolvelaCodeDiff :original="originalValue" :modified="innerCode" :language="currentLanguage" :theme="currentTheme" class="code-box" />
        </div>
...
<script setup>
  ...
  import SolvelaCodeDiff from '/@/components/business/code-editor/SolvelaCodeDiff.vue';
