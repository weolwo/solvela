...
-->
<template>
  <div class="solvela-stat-toggle">
    <a-button type="link" size="small" class="solvela-stat-toggle-btn" @click="open = !open">
      <template #icon>
    ...
    <span v-if="!open" class="solvela-stat-summary">
      <slot name="summary"></slot>
    </span>
    <div class="solvela-stat-range">
      <a-range-picker
        v-model:value="range"
  ...
  <div v-show="open">
    <div class="solvela-stat-note">统计范围：{{ rangeText }}（默认当天）。本面板不受下方列表筛选影响；标了「全量」的卡片也不受时间范围影响</div>
