...
<template>
  <a-layout class="admin-layout" style="min-height: 100%">
    ...
    <a-layout class="admin-layout-main" :style="`height: ${windowHeight}px`" :id="LAYOUT_ELEMENT_IDS.main">
      <!-- 顶部头部信息 -->
      <a-layout-header class="solvela-layout-header" :id="LAYOUT_ELEMENT_IDS.header" v-show="!fullScreenFlag">
      ...
      <!-- footer 版权公司信息 -->
      <a-layout-footer class="solvela-layout-footer" v-show="footerFlag"> <SolvelaFooter /></a-layout-footer>
      <!---- 回到顶部 --->
